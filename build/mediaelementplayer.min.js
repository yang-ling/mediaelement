...
(function(f){f.extend(MediaElementPlayer.prototype,{buildloop:function(a,b){var c=f('<div class="mejs-button mejs-loop-button '+(a.options.loop?"mejs-loop-on":"mejs-loop-off")+'"><button type="button" aria-controls="'+this.id+'" title="Toggle Loop" aria-label="Toggle Loop"></button></div>').appendTo(b).click(function(){a.options.loop=!a.options.loop;a.options.loop?c.removeClass("mejs-loop-off").addClass("mejs-loop-on"):c.removeClass("mejs-loop-on").addClass("mejs-loop-off")})}})})(mejs.$);
